...
const componetsVueJs = ['dgt-autocomplete', 'dgt-card', 'dgt-component-grid', 'dgt-grid', 'dgt-list', 'dgt-star-rating', 'dgt-tabs', 'dgt-tag-input', 'dgt-pagination', 'dgt-layout', 'dgt-toast'];
const banner =
    `${'/*!\n' +
